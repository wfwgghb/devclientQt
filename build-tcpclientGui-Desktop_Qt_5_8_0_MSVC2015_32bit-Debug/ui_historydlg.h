...
public:
    ...
    void setupUi(QDialog *Historydlg)
    {
        ...
        Historydlg->resize(677, 548);
        buttonBox = new QDialogButtonBox(Historydlg);
        buttonBox->setObjectName(QStringLiteral("buttonBox"));
        buttonBox->setGeometry(QRect(450, 490, 171, 32));
        buttonBox->setOrientation(Qt::Horizontal);
        buttonBox->setStandardButtons(QDialogButtonBox::Cancel|QDialogButtonBox::Ok);
        groupBox = new QGroupBox(Historydlg);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(30, 160, 591, 311));
        tableView = new QTableView(groupBox);
        tableView->setObjectName(QStringLiteral("tableView"));
        tableView->setGeometry(QRect(20, 20, 551, 241));
        ...
        horizontalLayoutWidget->setGeometry(QRect(20, 270, 111, 25));
        ...
        groupBox_2->setGeometry(QRect(100, 20, 441, 131));
        ...
        lineEdit_2->setGeometry(QRect(250, 20, 113, 20));
    ...
    void retranslateUi(QDialog *Historydlg)
    {
        ...
        label->setText(QApplication::translate("Historydlg", "\344\275\215\347\275\256\357\274\232", Q_NULLPTR));

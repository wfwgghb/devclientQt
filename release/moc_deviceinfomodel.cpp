...
#include "../tcpclientGui/deviceinfomodel.h"
...
QT_MOC_LITERAL(1, 16, 11), // "updateCount"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 5) // "count"

    },
    "DeviceInfoModel\0updateCount\0\0count"
};
...
void DeviceInfoModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DeviceInfoModel *_t = static_cast<DeviceInfoModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DeviceInfoModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DeviceInfoModel::updateCount)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DeviceInfoModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_DeviceInfoModel.data,
      qt_meta_data_DeviceInfoModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DeviceInfoModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DeviceInfoModel.stringdata0))
        return static_cast<void*>(const_cast< DeviceInfoModel*>(this));
...
// SIGNAL 0
void DeviceInfoModel::updateCount(int _t1)
{

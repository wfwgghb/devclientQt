...
#include "../tcpclientGui/historydlg.h"
...
QT_MOC_LITERAL(5, 82, 23) // "on_pushButton_4_clicked"
    ...
    "HistoryDlg\0on_pushButton_clicked\0\0"
...
void HistoryDlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HistoryDlg *_t = static_cast<HistoryDlg *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject HistoryDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_HistoryDlg.data,
      qt_meta_data_HistoryDlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HistoryDlg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HistoryDlg.stringdata0))
        return static_cast<void*>(const_cast< HistoryDlg*>(this));

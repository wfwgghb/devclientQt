...
QT_MOC_LITERAL(1, 11, 21), // "Send2httpserverSignal"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 6), // "result"
QT_MOC_LITERAL(4, 41, 7), // "Initial"
QT_MOC_LITERAL(5, 49, 12), // "finishedSlot"
QT_MOC_LITERAL(6, 62, 14), // "QNetworkReply*"
QT_MOC_LITERAL(7, 77, 5), // "reply"
QT_MOC_LITERAL(8, 83, 9), // "timerSlot"
QT_MOC_LITERAL(9, 93, 14), // "MsgFromTcpSlot"
QT_MOC_LITERAL(10, 108, 3) // "msg"

    },
    "HttpClient\0Send2httpserverSignal\0\0"
    "result\0Initial\0finishedSlot\0QNetworkReply*\0"
    "reply\0timerSlot\0MsgFromTcpSlot\0msg"
};
...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Send2httpserverSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->Initial(); break;
        case 2: _t->finishedSlot((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 3: _t->timerSlot(); break;
        case 4: _t->MsgFromTcpSlot((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpClient::Send2httpserverSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void HttpClient::Send2httpserverSignal(int _t1)
{
